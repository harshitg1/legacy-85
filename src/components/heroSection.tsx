...
export default function AboutUs() {
  ...
  return (
<section className="relative mt-20 min-h-[70vh] w-full overflow-hidden rounded-2xl border border-slate-200/20 shadow-2xl mx-4 my-6 bg-slate-950/20 backdrop-blur-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-5 space-y-5 relative z-20">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md rounded-full border border-white/20 text-white font-medium text-sm">
            ...
            <span className="text-green-300">Trading Academy Now Live</span>
          </div>
          ...
          {/* Description - card style - CONDENSED */}
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 border border-white/20 shadow-lg">
            <p className="text-sm md:text-base text-white/90 leading-relaxed">
              We've been empowering traders worldwide with cutting-edge education, innovative tools, 
              and a supportive community that drives real results across global markets.
            </p>
          </div>
        ...
        <div className="lg:col-span-7 relative">
          ...
          <div className="relative z-20 bg-slate-900/70 backdrop-blur-xl rounded-2xl p-5 border border-white/25 shadow-2xl hover:bg-slate-800/75 transition-all duration-500 group max-w-sm ml-auto mr-16">
          ...
          <div className="absolute top-8 right-4 group">
            <div className="relative bg-slate-800/80 backdrop-blur-lg p-3 rounded-xl shadow-xl border border-white/40 z-30 transform hover:rotate-2 hover:scale-105 transition-all duration-300 max-w-[140px]">
              <div className="flex items-center gap-2">
          ...
          <div className="absolute bottom-8 right-20 group">
            <div className="relative bg-slate-800/80 backdrop-blur-lg p-3 rounded-xl shadow-xl border border-white/40 z-30 transform hover:-rotate-2 hover:scale-105 transition-all duration-300 max-w-[140px]">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-300 mt-0.5">+127% Success Rate</p>
                </div>
              </div>
            </div>
          </div>
